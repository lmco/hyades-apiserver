...
class UserResourceAuthenticatedTest extends ResourceTest {
        ...
        public void getUsersTest() {
                ...
                AssertionsForInterfaceTypes.assertThat(expectedStatuses).isEqualTo(statuses);

                JsonArray users = parseJsonArray(responseAll);
                boolean testLength = users.toArray().length >= 3;
                Assertions.assertThat(testLength).isTrue();
        }
        ...
        void createLdapUserTest() {
                ...
                Assertions.assertThat(qm.getNotificationOutbox()).satisfiesExactly(notification -> {
                        Assertions.assertThat(notification.getScope()).isEqualTo(SCOPE_SYSTEM);
                        Assertions.assertThat(notification.getGroup()).isEqualTo(GROUP_USER_CREATED);
                        Assertions.assertThat(notification.getLevel()).isEqualTo(LEVEL_INFORMATIONAL);
                        Assertions.assertThat(notification.getTitle()).isEqualTo("User Created");
                        Assertions.assertThat(notification.getContent()).isEqualTo("User blackbeard was created");
                });
        }
        ...
        void deleteLdapUserTest() {
                ...
                Assertions.assertThat(qm.getNotificationOutbox()).satisfiesExactly(notification -> {
                        Assertions.assertThat(notification.getScope()).isEqualTo(SCOPE_SYSTEM);
                        Assertions.assertThat(notification.getGroup()).isEqualTo(GROUP_USER_DELETED);
                        Assertions.assertThat(notification.getLevel()).isEqualTo(LEVEL_INFORMATIONAL);
                        Assertions.assertThat(notification.getTitle()).isEqualTo("User Deleted");
                        Assertions.assertThat(notification.getContent()).isEqualTo("User blackbeard was deleted");
                });
        }
        ...
        void shouldReturnEffectivePermissions() {
                ...
                Assertions.assertThat(json.getValuesAs(jakarta.json.JsonString::getString))
        ...
        void shouldLogoutAndInvalidateSession() {
                ...
                final Response beforeResponse = jersey
                                ...
                                .header("Authorization", "Bearer " + sessionToken)
                                .get(Response.class);
                Assertions.assertThat(beforeResponse.getStatus()).isEqualTo(200);
                ...
                final Response logoutResponse = jersey
                                ...
                                .header("Authorization", "Bearer " + sessionToken)
                                .post(Entity.json(""));
                Assertions.assertThat(logoutResponse.getStatus()).isEqualTo(204);
                ...
                final Response afterResponse = jersey
                                ...
                                .header("Authorization", "Bearer " + sessionToken)
                                .get(Response.class);
                Assertions.assertThat(afterResponse.getStatus()).isEqualTo(401);
        }
        ...
        void shouldNotRevokeSessionOfDifferentUser() {
                ...
                final Response afterResponse = jersey
                                ...
                                .header("Authorization", "Bearer " + otherToken)
                                .get(Response.class);
                Assertions.assertThat(afterResponse.getStatus()).isEqualTo(200);
        }
