...
public enum ConfigPropertyConstants {
    ...
    GITLAB_JWKS_PATH("integrations", "gitlab.jwks.path", null, PropertyType.ENCRYPTEDSTRING, "The path to the private key that is used when authenticating to GitLab", ConfigPropertyAccessMode.READ_WRITE),
